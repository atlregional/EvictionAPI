...
--
-- Name: atlanta_metro_area_case; Type: TABLE; Schema: data; Owner: superuser
--

CREATE TABLE data.atlanta_metro_area_case (
    id text NOT NULL,
    street text,
    city text,
    zip text,
...
--
-- Name: atlanta_metro_area_cases; Type: VIEW; Schema: api; Owner: api
--

CREATE VIEW api.atlanta_metro_area_cases AS
...
ALTER TABLE api.atlanta_metro_area_cases OWNER TO api;
...
--
-- Name: fulton_county_case; Type: TABLE; Schema: data; Owner: superuser
--

CREATE TABLE data.fulton_county_case (
    filedate text,
...
--
-- Name: fulton_county_cases; Type: VIEW; Schema: api; Owner: api
--

CREATE VIEW api.fulton_county_cases AS
 SELECT fulton_county_case.filedate,
    fulton_county_case.caseid
   FROM data.fulton_county_case;


ALTER TABLE api.fulton_county_cases OWNER TO api;
...
--
-- Name: atlanta_metro_area_case atlanta_metro_area_case_pkey; Type: CONSTRAINT; Schema: data; Owner: superuser
--

ALTER TABLE ONLY data.atlanta_metro_area_case
...
--
-- Name: fulton_county_case fulton_county_case_pkey; Type: CONSTRAINT; Schema: data; Owner: superuser
--

ALTER TABLE ONLY data.fulton_county_case
...
GRANT ALL ON FUNCTION api.signup(name text, email text, password text) TO webuser;


--
-- Name: TABLE atlanta_metro_area_case; Type: ACL; Schema: data; Owner: superuser
--

GRANT SELECT ON TABLE data.atlanta_metro_area_case TO api;


--
-- Name: TABLE atlanta_metro_area_cases; Type: ACL; Schema: api; Owner: api
--

GRANT SELECT ON TABLE api.atlanta_metro_area_cases TO webuser;
...
--
-- Name: TABLE fulton_county_case; Type: ACL; Schema: data; Owner: superuser
--

GRANT SELECT ON TABLE data.fulton_county_case TO api;


--
-- Name: TABLE fulton_county_cases; Type: ACL; Schema: api; Owner: api
--

GRANT SELECT ON TABLE api.fulton_county_cases TO anonymous;
